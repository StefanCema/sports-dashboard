      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label={
              favorited
                ? `Remove ${match.homeTeam} vs ${match.awayTeam} from favorites`
                : `Add ${match.homeTeam} vs ${match.awayTeam} to favorites`
            }
      ...
      <div className="flex items-center">
        ...
        <div className="text-center px-4">
          {match.status === "upcoming" ? (
            ...
            <p
              className={`text-2xl font-semibold tracking-widest ${isFinished ? "text-gray-400" : "text-gray-800 dark:text-white"}`}
            >
